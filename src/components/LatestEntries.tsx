...
export const LatestEntries = ({ items }: { items: Announcement[] }) => (
    <div className="flex-1">
        <div className="flex justify-between items-end mb-4 sm:mb-6 border-b border-line pb-4">
            <h2 className="mono-label flex items-center gap-2 text-[9px] sm:text-[10px]">
                <div className="w-1.5 h-1.5 bg-accent rounded-full animate-pulse" />
                Najnowsze wpisy
            </h2>
            <button className="mono-label flex items-center gap-1 hover:text-accent hover:opacity-100 transition-all text-[8px] sm:text-[9px]">
